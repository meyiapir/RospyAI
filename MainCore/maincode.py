...
alias_wh = ['Чё как', 'чё как', 'чё как?', 'Чё как?', 'Как дела?', 'как дела?', 'Как дела', 'как дела', 'чо как?', 'Чо как?',
            'чо как', 'Чо как', 'Как сам', 'как сам', 'Че как', 'че как', 'Че как?', 'Че как?', 'Какие дела?', 'Какие дела',
            'дела', 'Дела', 'Жизнь', 'жизнь', 'Как жизнь', 'Чем занимаешься', 'заним', 'ешься', 'чем занимаешься', 'чем занимаешся']
...
alias_pgen = ['Генератор паролей', 'паролей', 'генератор паролей', 'поролей', 'Паролей', 'Поролей', 'лей', 'паро',
              'поро', 'Сгенерируй пароль', 'сгенерируй пароль', 'сгенерируй пороль', 'пароль', 'Пароль', 'Пароля', 'Паролей',
              'Открой генератор', 'открой генератор', 'Запусти генератор', 'запусти генератор', 'passgen', 'pg']

alias_ip_log = ['ip', 'IP', 'айпи', 'ойпи', 'интернет адрес', 'Интернет адрес']

alias_pohval = ['Какой я', 'какой я', 'я', 'Похвали меня', 'что ты думаешь обо мне', 'думаешь обо мне', 'похвали',
                'пахвали', 'пахв', 'али', 'комплемент', 'компл', 'емент', 'какой я', 'Я', 'pohval_mod', 'I', 'i']
...
# ----------------------------------------------
    ...
    elif any(element in main_input for element in alias_pgen):
        run_mod()
        pass_gen_mod()

    elif any(element in main_input for element in alias_ip_log):
        run_mod()
        ip_log_mod()

    elif any(element in main_input for element in alias_pohval):
        pohval_mod()
# ***********************************************************************************************************
# ***********************************************************************************************************
